...
if not st.session_state.authenticated:
    ...
    with col1:
        st.image("https://via.placeholder.com/300x400?text=VACPA+"https://thumbs.dreamstime.com/b/woman-sorting-cocoa-beans-wooden-tray-chocolate-production-image-showcases-meticulously-vital-step-process-hands-373632895.jpg", width=300)
    with col2:
